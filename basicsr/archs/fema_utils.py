...
class ResBlock_wz(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, norm_type='gn', act_type='leakyrelu'):
        super(ResBlock_wz, self).__init__()
        self.conv_z = nn.Conv2d(1, in_channel, 3, stride=1, padding=1)
        self.p2sconv = P2Sconv(in_channel, 128, in_channel)
